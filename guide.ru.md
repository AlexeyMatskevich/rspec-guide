...
- [3. Каждый example (`it`) описывает одно наблюдаемое поведение](#3-каждый-example-it-описывает-одно-наблюдаемое-поведение)
  - [2.1. Исключение для интерфейсного тестирования](#21-исключение-для-интерфейсного-тестирования)
  - [2.2. Работа с большими интерфейсами](#22-работа-с-большими-интерфейсами)
