...
FactoryBot помогает описывать характеристики доменных объектов через трейты и параметризованные хэши, поэтому используем его, чтобы тесты говорили о поведении, а не о технических атрибутах.
