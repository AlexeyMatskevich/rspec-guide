...
**Философия подробно:** [Про RSpec](../guide.ru.md#про-rspec) | [Три идеи руководства](../guide.ru.md#три-идеи-этого-руководства)
...
**Подробнее:** [Пирамида тестирования](../guide.ru.md#пирамида-тестирования-и-выбор-уровня)
...
**Подробнее:** [Правило 4.1: Выделите характеристики и состояния](../guide.ru.md#41-выделите-характеристики-и-состояния)
...
**Подробнее:** [Правило 4.2: Постройте иерархию: зависимые / независимые](../guide.ru.md#42-постройте-иерархию-зависимые--независимые)
...
**Подробнее:** [Правило 10.3: Ключевые слова контекстов when/with/and/but/NOT](../guide.ru.md#103-ключевые-слова-контекстов-whenwithandbutnot)
...
- [Правило 3: Один it — одно поведение](../guide.ru.md#3-один-it--одно-поведение)
...
**Подробнее:** [Правило 4.3: Положительный / отрицательный тест](../guide.ru.md#43-положительный--отрицательный-тест)
...
**Подробнее:** 
- [Правило 10.1: context + it = валидное предложение](../guide.ru.md#101-context--it--валидное-предложение)
- [Правило 10.2: Грамматика: Present Simple, активный залог](../guide.ru.md#102-грамматика-present-simple-активный-залог)
- [Правило 10.3: Ключевые слова контекстов when/with/and/but/NOT](../guide.ru.md#103-ключевые-слова-контекстов-whenwithandbutnot)
...
**Подробнее:** 
- [Правило 5: Три фазы: given / when / then](../guide.ru.md#5-три-фазы-given--when--then)
...
**Подробнее:** 
- [Правило 9.1: Traits для характеристик](../guide.ru.md#91-traits-для-характеристик)
- [Правило 9.3: build_stubbed для юнит-тестов](../guide.ru.md#93-build_stubbed-для-юнит-тестов)
...
**Подробнее:** [Правило 6: Объявляйте subject явно](../guide.ru.md#6-объявляйте-subject-явно)
...
**Подробнее:** [Правило 17: Делайте вывод падения читаемым](../guide.ru.md#17-делайте-вывод-падения-читаемым)
...
**Подробнее:** [Правило 2: Проверяйте, что тест ловит баги](../guide.ru.md#2-проверяйте-что-тест-ловит-баги)
...
**Подробнее:** 
- [Правило 4.5: Аудит: дубликаты и инварианты](../guide.ru.md#45-аудит-дубликаты-и-инварианты)
- [Правило 14: Shared examples для контрактов](../guide.ru.md#14-shared-examples-для-контрактов)
...
**Подробнее:** 
- [Правило 3: Один it — одно поведение](../guide.ru.md#3-один-it--одно-поведение)
- [Правило 11: aggregate_failures для интерфейсных тестов](../guide.ru.md#11-aggregate_failures-для-интерфейсных-тестов)
...
| Неявные зависимости | Тесты падают при изменении порядка | Изолируйте контексты ([Правило 4.2](../guide.ru.md#42-постройте-иерархию-зависимые--независимые)) |
| Дублирование | Копипаста в setup/expects | Shared examples ([Правило 14](../guide.ru.md#14-shared-examples-для-контрактов)), фабрики ([Правило 9.1](../guide.ru.md#91-traits-для-характеристик)) |
| Нечитаемый вывод | Стена текста при падении | Правильные матчеры ([Правило 17](../guide.ru.md#17-делайте-вывод-падения-читаемым)) |
