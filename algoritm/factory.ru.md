...
- ✅ Структура контекстов уже построена ([Правило 5](../guide.ru.md#5-стройте-иерархию-context-по-зависимостям-характеристик-happy-path--corner-cases))
- ✅ Характеристики и состояния определены ([Правило 4](../guide.ru.md#4-выделяйте-характеристики-поведения-и-их-состояния))
- ✅ Описания поведений написаны ([Правила 17-18](../guide.ru.md#17-описание-контекстов-context-и-тестовых-кейсов-it-вместе-включая-it-должны-составлять-валидное-предложение-на-английском-языке))
...
### Почему это важно
Трейты документируют состояния характеристик и делают тесты читаемыми на уровне бизнес-языка ([Правила 17-18](../guide.ru.md#17-описание-контекстов-context-и-тестовых-кейсов-it-вместе-включая-it-должны-составлять-валидное-предложение-на-английском-языке)).
...
**Подробнее:** [Правило 13: attributes_for](../guide.ru.md#13-используйте-attributes_for-для-генерации-параметров-которые-не-являются-важной-деталью-в-тестировании-поведения), [Правило 14: build_stubbed](../guide.ru.md#14-в-юнит-тестах-кроме-моделей-используйте-build_stubbed)
...
**Подробнее:** [Правило 12: Используйте возможности FactoryBot](../guide.ru.md#12-используйте-возможности-factorybot-для-скрытия-деталей-исходных-данных)
...
**Подробнее:** [Правило 5: Объединение по доменам на интеграционном уровне](../guide.ru.md#5-стройте-иерархию-context-по-зависимостям-характеристик-happy-path--corner-cases), [Pattern #4: Traits в characteristic-based contexts](../patterns.ru.md#4-traits-в-characteristic-based-contexts)
...
- [ ] Правило 12: Технические детали скрыты
- [ ] Правило 13: `attributes_for` для параметров
- [ ] Правило 14: `build_stubbed` в юнит-тестах
- [ ] Правило 16: Явность характеристик сохранена
...
| Хрупкие фабрики | Падают при изменении модели | Минимум обязательных атрибутов ([Правило 12](../guide.ru.md#12-используйте-возможности-factorybot-для-скрытия-деталей-исходных-данных)) |
...
1. **Соответствует характеристикам из тестов** — трейты = состояния ([Правило 4](../guide.ru.md#4-выделяйте-характеристики-поведения-и-их-состояния))
2. **Скрывает техническую сложность** — фокус на бизнес-логике ([Правило 12](../guide.ru.md#12-используйте-возможности-factorybot-для-скрытия-деталей-исходных-данных))
3. **Ускоряет выполнение** — правильные методы для правильных задач ([Правила 13-14](../guide.ru.md#13-используйте-attributes_for-для-генерации-параметров-которые-не-являются-важной-деталью-в-тестировании-поведения))
...
- [Все правила FactoryBot в основном гайде](../guide.ru.md#factorybot-и-подготовка-данных)
