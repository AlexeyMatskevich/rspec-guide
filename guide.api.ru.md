...
**Решение:** См. [aggregate_failures в guide.ru.md](guide.ru.md#11-aggregate_failures-для-интерфейсных-тестов) для бизнес-проверок, [JSON Schema](#1-json-schema-validation-thoughtbotjson_matchers) для контракта.
