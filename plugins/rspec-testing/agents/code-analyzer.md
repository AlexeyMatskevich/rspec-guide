...
complexity:
  ...
  loc: 142
  methods: 6
  warning: (if yellow/red)
dependencies: [Payment, User]  # Classes this file depends on
spec_path: spec/services/payment_processor_spec.rb
```

**Complexity already assessed** — discovery-agent handles zones and stop decisions.

## Phase 1: Prerequisites

Verify the target class/method exists:

1. Use Serena to find the class
2. Confirm method exists (if specified)
